...
<!--
		<div style="height=30px;display:expression(window.name == 'application_frame' ? 'none' : 'block')" align=right><br><a class="lnk0" href="/i/setup.exe">Установить...</a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
-->
			...
			<tr>
				<td align=middle>   
					<table cellspacing=0 cellpadding=0 border=0>      
						<form action=$_REQUEST{__uri} method=get autocomplete="off">
							...
							<tr>
								...
								<td valign=top>
									...
									<table height=32 cellspacing=0 cellpadding=0 border=0>
										...
										<tr>
											<td>
												<table height=68 cellspacing=0 cellpadding=0 width=260 border=0>


								@{[ $data -> {user} -> {id} ? <<EOL : '' ]}
						<tr height=40>
							<td bgcolor=#8e8e8e colspan=3 align=center _bgcolor="#1C1A18"><a id="logon_url" href="/?type=logon&action=execute_ip" class="lnk2"><b>Connecter comme ${$$data{user}}{label}...</b></a>
							</td>
						</tr>
EOL
													...
													<tr>
														...
														<td class=color0 bgcolor=#8e8e8e>&nbsp;<b>nom:</b>&nbsp;</td>
													...
													<tr>
														<td class=color0 bgcolor=#8e8e8e>&nbsp;<b>mot de passe:</b>&nbsp;</td>
										...
										<tr>
											<td bgcolor=#d1d0d0>
												<table height=23 cellspacing=0 cellpadding=0 align=center border=0>
													<tr>
														<td align=right bgcolor=#d1d0d0><input class=txt7 type=submit value=connecter>&nbsp;</td>
<!--														
														<td align=left bgcolor=#d1d0d0>&nbsp;<input class=txt7 type=submit value=сброс></td>
-->														
													</tr>
												</table>
											</td>
